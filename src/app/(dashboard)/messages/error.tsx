...
export default function MessagesError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h2 className="text-lg font-semibold text-ink mb-2">Messages Error</h2>
      <p className="text-sm text-muted mb-6 max-w-sm">Failed to load messages. Please try again.</p>
